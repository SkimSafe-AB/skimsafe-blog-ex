-- Insert Phoenix Installation Guide into SQLite database
-- Run this with: sqlite3 skimsafe_blogg_dev.sqlite3 < insert_phoenix_installation_guide.sql
...
INSERT INTO posts (
    ...
    'Getting started with Phoenix Framework is straightforward, but there are a few prerequisites you''ll need to have in place. This comprehensive guide will walk you through installing Phoenix on your system step by step.',
    '# Phoenix Installation Guide
...
Happy coding with Phoenix! 🔥',
    'Tech Team',
    'tech@skimsafe.se',
    '["Phoenix", "Installation", "Setup", "Getting Started", "Elixir"]',
    0,
    1,
    '2024-11-28 09:00:00',
    5,
