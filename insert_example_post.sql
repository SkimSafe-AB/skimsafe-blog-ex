-- Insert example blog post into SQLite database
-- Run this with: sqlite3 skimsafe_blogg_dev.sqlite3 < insert_example_post.sql
...
*Ready to start building with LiveView? Check out our [Phoenix installation guide](/posts/phoenix-installation) to get started.*',
    'Sarah Chen',
    'sarah.chen@skimsafe.com',
    '["Phoenix", "LiveView", "Elixir", "Real-time", "Web Development"]',
    1,
    1,
    '2024-12-15 10:00:00',
    12,
